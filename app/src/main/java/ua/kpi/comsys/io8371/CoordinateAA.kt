...
class CoordinateAA {
    ...
    fun averageCoordinate( y: CoordinateAA): CoordinateAA?{
        when{
            this.direction == Direction.LENGTH && y.direction == Direction.LENGTH -> {
                return CoordinateAA((this.seconds+y.seconds)/2, (this.minutes+y.minutes)/2, (this.degrees+y.degrees)/2, Direction.LENGTH)
            }
            this.direction == Direction.WIDTH && y.direction == Direction.WIDTH -> {
                return CoordinateAA((this.seconds+y.seconds)/2, (this.minutes+y.minutes)/2, (this.degrees+y.degrees)/2,Direction.WIDTH)
            }
        }
        return null
    }

    fun averageCoordinateTwoParameters(x: CoordinateAA, y: CoordinateAA): CoordinateAA?{
        when{
            x.direction == Direction.LENGTH && y.direction == Direction.LENGTH -> {
                return CoordinateAA((x.seconds+y.seconds)/2, (x.minutes+y.minutes)/2, (x.degrees+y.degrees)/2, Direction.LENGTH)
            }
            x.direction == Direction.WIDTH && y.direction == Direction.WIDTH -> {
                return CoordinateAA((x.seconds+y.seconds)/2, (x.minutes+y.minutes)/2, (x.degrees+y.degrees)/2, Direction.WIDTH)
            }
        }
        return null
    }
    ...
    override fun toString(): String {
        return "CoordinateAA(direction=$direction, minutes=$minutes, seconds=$seconds, degrees=$degrees)"
    }
